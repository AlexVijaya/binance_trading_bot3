...
path_to_db=os.path.join(os.getcwd(),"datasets",
                                    "sql_databases",
                                    "binance_multiple_tables_historical_data.db")
create_empty_database(path_to_db)
#
# def populate_db_with_empty_tables(path_to_db):
#     connection_to_tickers = sqlite3.connect ( os.path.join ( os.getcwd () ,
#                                                                  "datasets" ,
#                                                                  "sql_databases" ,
#                                                                  "binance_trading_pairs.db" ) )
#     connection_to_db_for_creating_empty_tables=sqlite3.connect(path_to_db)
#
...
#
#     cur=connection_to_db_for_creating_empty_tables.cursor()
...
#                         (row_number int);
#                         ''')
#             connection_to_db_for_creating_empty_tables.commit()
#         except Exception as e:
#             print(f'problem in {trading_pair} \n',e)
#
#     connection_to_db_for_creating_empty_tables.close()
#     connection_to_tickers.close()
# populate_db_with_empty_tables(path_to_db)
#
...
def insert_binance_trading_pair_ohlc_into_db(interval = '1d',connection_to_prices=sqlite3.connect(os.path.join(os.getcwd(),
                                            ...
                                            "sql_databases","binance_multiple_tables_historical_data.db"),
    ...
    for symbol in tickers_df['trading_pair']:
        try:
            ...
            klines_df.to_sql(f"{symbol}",connection_to_prices,if_exists = 'replace')
            #
